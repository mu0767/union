...
let graphModulePromise = null, graphModule = null;
...
async function solveMaxFlowDirect(payload) {
  const module = currentModule(), tailsPtr = copyFloat64ToHeap(module, payload.tails), headsPtr = copyFloat64ToHeap(module, payload.heads), capacitiesPtr = copyFloat64ToHeap(module, payload.capacities);
  try {
...
async function solveMinCostFlowDirect(payload) {
  const module = currentModule(), tailsPtr = copyFloat64ToHeap(module, payload.tails), headsPtr = copyFloat64ToHeap(module, payload.heads), capacitiesPtr = copyFloat64ToHeap(module, payload.capacities), unitCostsPtr = copyFloat64ToHeap(module, payload.unitCosts), suppliesPtr = copyFloat64ToHeap(module, payload.supplies);
  try {
    return parseResult(await module.ccall(
...
async function solveLinearSumAssignmentDirect(payload) {
  const module = currentModule(), leftNodesPtr = copyFloat64ToHeap(module, payload.leftNodes), rightNodesPtr = copyFloat64ToHeap(module, payload.rightNodes), costsPtr = copyFloat64ToHeap(module, payload.costs);
  try {
    return parseResult(await module.ccall(
...
class SimpleMaxFlow {
  ...
  add_arcs_with_capacity(tails, heads, capacities) {
    const tailValues = toNumberArray(tails, "tails"), headValues = toNumberArray(heads, "heads"), capacityValues = toNumberArray(capacities, "capacities");
  ...
  set_arcs_capacity(arcs, capacities) {
    const arcValues = toNumberArray(arcs, "arcs"), capacityValues = toNumberArray(capacities, "capacities");
...
class SimpleMinCostFlow {
  ...
  add_arcs_with_capacity_and_unit_cost(tails, heads, capacities, unitCosts) {
    const tailValues = toNumberArray(tails, "tails"), headValues = toNumberArray(heads, "heads"), capacityValues = toNumberArray(capacities, "capacities"), unitCostValues = toNumberArray(unitCosts, "unitCosts");
  ...
  set_nodes_supplies(nodes, supplies) {
    const nodeValues = toNumberArray(nodes, "nodes"), supplyValues = toNumberArray(supplies, "supplies");
...
class SimpleLinearSumAssignment {
  ...
  add_arcs_with_cost(leftNodes, rightNodes, costs) {
    const leftValues = toNumberArray(leftNodes, "leftNodes"), rightValues = toNumberArray(rightNodes, "rightNodes"), costValues = toNumberArray(costs, "costs");
